...
TETRIS_CONTROLER_FILE = $(SRC_DIR)/gui/cli/controler_tetris.c
SNAKE_BACKEND_FILE = $(SRC_DIR)/BrickGame/BackEnd_Snake/Backend_snake.cc
SNAKE_CONTROLER_FILE = $(SRC_DIR)/gui/cli/controler_snake.cc
...
TETRIS_CONTROLER_OBJ = $(TETRIS_OBJ_DIR)/controler_tetris.o
...
$(TETRIS_OBJ_DIR)/controler_tetris.o:	$(TETRIS_CONTROLER_FILE) | $(BUILD_DIR)
	$(CC) $(CFLAGS) -c $< -o $@	
